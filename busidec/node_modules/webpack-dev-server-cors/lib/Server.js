...
function Server(compiler, options) {
	...
	var signalledServerStart = false;
	compiler.plugin("compile", invalidPlugin);
	compiler.plugin("invalid", invalidPlugin);
	compiler.plugin("done", function(stats) {
		this._sendStats(this.sockets, stats.toJson());
		this._stats = stats;
		if (!signalledServerStart) {
			this.emit("webpackDevServer.started", this.options);
			signalledServerStart = true;
		}
	}.bind(this));
...
Server.prototype.close = function() {
	...
	this.emit("webpackDevServer.closed", this.options);
}
